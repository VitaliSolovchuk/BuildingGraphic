...
namespace BuildingGraphic.Models
{
    ...
    {
        [Display(Name = "from")]
        [Required(ErrorMessage = "Поле 'from' должно быть установлено")]
        ...
        [Display(Name = "to")]
        [Required(ErrorMessage = "Поле 'to' должно быть установлено")]
        //[StringLength(5, MinimumLength = 1, ErrorMessage = "Братан, я не супе ПК. Уменьши запросы=)")]
        //[RegularExpression(@"[0-9]", ErrorMessage = "Некорректныая точка")]
        
        public float StopPosition { get; set; }
        [Display(Name = "step")]
        [Required(ErrorMessage = "Поле 'step' должно быть установлено")]
        //[StringLength(5, MinimumLength = 1, ErrorMessage = "Братан, я не супе ПК. Уменьши запросы=)")]
